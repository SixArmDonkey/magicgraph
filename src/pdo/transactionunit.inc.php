 ...
 * @final
 */
final class TransactionUnit implements ITransactionUnit
{
  /**
   * If the supplied db connection had a transaction started 
   * @var bool  
   */
  private bool $parentTrans;
   ...
   */
  public function __construct( IDBConnection $dbc, bool $beginTransaction = true )
  {    
    $this->parentTrans = $dbc->inTransaction();
    $this->dbc = $dbc;
    if ( $beginTransaction )
   ...
   */
  public final function hasParentTrans() : bool
  {
