 ...
 * 
 */
class DefaultEnumPropertyTest extends AbstractEnumPropertyTest
{
  /**
  ...
  {
    return new DefaultEnumProperty( SampleEnum::class, $name, $defaultValue->value(), $behavior, ...$flags->getActiveMembers());
  }
  ...
  {    
    $prop = $this->makeProperty( 'test', $this->getPropertyType(), new SPropertyFlags(), new PropertyBehavior(), SampleEnum::KEY1());
    $prop->setValue( SampleEnum::KEY2());
    $this->assertEquals( SampleEnum::KEY2, (string)$prop->getValue());
  }
}
