...
#[Attribute]
class EnumProperty extends \buffalokiwi\magicgraph\property\EnumProperty
{
  public function __construct( string $name, string $clazz = '', string $defaultValue = '', 
    array $flags = [], string $behaviorClass = '', string $flagsClass = SPropertyFlags::class )
  {
    ...
    $builder = new ObjectPropertyBuilder( EPropertyType::TENUM(), $fc, null );
